...
{
    internal static class MatchRating
    {
        ...
        public static bool GenerateMatchRating(string name, out string key)
        {
            ...
            if (upperName.Length > 1)
            {
                ...
                upperName = start + PhoneticHelper.VOWELS.Replace(upperName.Substring(1), string.Empty);
            }
        ...
        internal static string CollapseRepeatingConsonants(string name)
        {
            ...
            {
                if (c != prev || first || PhoneticHelper.IsVowel(c))
                {
                    sb.Append(c);
                    first = false;
                }
        ...
        internal static int MatchRatingCompute(string name1, string name2)
        {
            ...
            large = PhoneticHelper.ReverseString(large);
            small = PhoneticHelper.ReverseString(small);
